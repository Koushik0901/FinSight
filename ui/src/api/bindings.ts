...
export type Account = { id: string; owner: string; bank: string; type: AccountType; name: string; last4: string | null; currency: string; color: string; archived_at: string | null; created_at: string; simplefin_account_id: string | null; last_synced_at: string | null; nickname: string | null }
export type AccountPatch = { name: string | null; bank: string | null; account_type: AccountType | null; color: string | null; last4: string | null; currency: string | null; nickname: string | null }
export type AccountSummary = { id: string; owner: string; bank: string; type: AccountType; name: string; balance_cents: number; currency: string; color: string; source: string; simplefin_account_id: string | null; last_synced_at: string | null; nickname: string | null }
...
export type NewAccount = { owner: string; bank: string; type: AccountType; name: string; last4: string | null; currency: string; color: string; opening_balance_cents: number; source?: string; simplefin_account_id: string | null; nickname: string | null }
