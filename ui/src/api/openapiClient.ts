...
export const api = {
  ...
  setModelRouting: (config: components["schemas"]["ModelRoutingConfig"]) => wrap<null>(raw.POST("/api/rpc/set_model_routing", { body: { config } })),
  getModelRouting: () => wrap<components["schemas"]["ModelRoutingConfig"]>(raw.POST("/api/rpc/get_model_routing", {})),
  ...
  listBudgetEnvelopes: (month?: string) => wrap<components["schemas"]["BudgetEnvelope"][]>(raw.POST("/api/rpc/list_budget_envelopes", { body: month ? { month } : {} } as never)),
  ...
  setBudget: (categoryId: string, amountCents: number, allowOverAssign?: boolean, month?: string) => wrap<null>(raw.POST("/api/rpc/set_budget", { body: { categoryId, amountCents, ...(allowOverAssign !== undefined ? { allowOverAssign } : {}), ...(month ? { month } : {}) } as unknown as components["schemas"]["SetBudgetRequest"] & { allowOverAssign?: boolean; month?: string } })),
  ...
  listReportWidgets: () => wrap<components["schemas"]["ReportWidget"][]>(raw.POST("/api/rpc/list_report_widgets", {})),
  ...
  getCashflowForecast: (horizonDays: number | null, bufferCents: number | null, extraExpenseCents: number | null, extraExpenseDate: string | null, includeMerchantKeys: string[] | null) => wrap<components["schemas"]["CashflowForecast"]>(raw.POST("/api/rpc/get_cashflow_forecast", { body: { horizonDays, bufferCents, extraExpenseCents, extraExpenseDate, includeMerchantKeys } })),
...
export type ModelRoutingConfig = components["schemas"]["ModelRoutingConfig"];
export type SetModelRoutingRequest = components["schemas"]["SetModelRoutingRequest"];
