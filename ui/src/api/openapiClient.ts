...
export const api = {
  listAccounts: () => wrap<components["schemas"]["AccountSummary"][]>(raw.POST("/api/rpc/list_accounts", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listCategoryGroups: () => wrap<components["schemas"]["CategoryGroup"][]>(raw.POST("/api/rpc/list_category_groups", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listCategories: () => wrap<components["schemas"]["CategoryDto"][]>(raw.POST("/api/rpc/list_categories", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getSpendingBreakdown: () => wrap<components["schemas"]["SpendingBreakdown"]>(raw.POST("/api/rpc/get_spending_breakdown", { body: {} } as unknown as { body: Record<string, never> })),
  getOnboardingState: () => wrap<components["schemas"]["OnboardingState"]>(raw.POST("/api/rpc/get_onboarding_state", { body: {} } as unknown as { body: Record<string, never> })),
  markOnboardingComplete: () => wrap<null>(raw.POST("/api/rpc/mark_onboarding_complete", { body: {} } as unknown as { body: Record<string, never> })),
  resetOnboardingCompletion: () => wrap<null>(raw.POST("/api/rpc/reset_onboarding_completion", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  appReady: () => wrap<components["schemas"]["AppReady"]>(raw.POST("/api/rpc/app_ready", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listUnfinishedImports: () => wrap<components["schemas"]["Import"][]>(raw.POST("/api/rpc/list_unfinished_imports", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getCompletionProvider: () => wrap<components["schemas"]["CompletionProviderConfig"]>(raw.POST("/api/rpc/get_completion_provider", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getNeedsReviewCount: () => wrap<number>(raw.POST("/api/rpc/get_needs_review_count", { body: {} } as unknown as { body: Record<string, never> })),
  triggerCategorize: () => wrap<null>(raw.POST("/api/rpc/trigger_categorize", { body: {} } as unknown as { body: Record<string, never> })),
  recomputeAnomalies: () => wrap<number>(raw.POST("/api/rpc/recompute_anomalies", { body: {} } as unknown as { body: Record<string, never> })),
  setAnomalyDismissed: (txnId: string, dismissed: boolean) => wrap<null>(raw.POST("/api/rpc/set_anomaly_dismissed", { body: { txnId, dismissed } })),
  triggerRecategorizeLowConfidence: () => wrap<null>(raw.POST("/api/rpc/trigger_recategorize_low_confidence", { body: {} } as unknown as { body: Record<string, never> })),
  getAgentStatus: () => wrap<components["schemas"]["AgentStatus"]>(raw.POST("/api/rpc/get_agent_status", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listCategoriesWithSpending: () => wrap<components["schemas"]["CategoryWithSpending"][]>(raw.POST("/api/rpc/list_categories_with_spending", { body: {} } as unknown as { body: Record<string, never> })),
  listRulesWithCategories: () => wrap<components["schemas"]["RuleWithCategory"][]>(raw.POST("/api/rpc/list_rules_with_categories", { body: {} } as unknown as { body: Record<string, never> })),
  toggleRule: (id: string, enabled: boolean) => wrap<null>(raw.POST("/api/rpc/toggle_rule", { body: { id, enabled } })),
  listBudgetEnvelopes: () => wrap<components["schemas"]["BudgetEnvelope"][]>(raw.POST("/api/rpc/list_budget_envelopes", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  setBudget: (categoryId: string, amountCents: number) => wrap<null>(raw.POST("/api/rpc/set_budget", { body: { categoryId, amountCents } })),
   ...
   listFundingTemplates: () => wrap<components["schemas"]["FundingTemplate"][]>(raw.POST("/api/rpc/list_funding_templates", { body: {} } as unknown as { body: Record<string, never> })),
   ...
   listBudgetTransfers: (month: string) => wrap<components["schemas"]["BudgetTransfer"][]>(raw.POST("/api/rpc/list_budget_transfers", { body: { month } })),
    ...
    listGoals: () => wrap<components["schemas"]["GoalDto"][]>(raw.POST("/api/rpc/list_goals", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listRecurring: () => wrap<components["schemas"]["RecurringItem"][]>(raw.POST("/api/rpc/list_recurring", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getMonthTotals: () => wrap<components["schemas"]["MonthTotals"]>(raw.POST("/api/rpc/get_month_totals", { body: {} } as unknown as { body: Record<string, never> })),
  getSavingsRateHistory: () => wrap<components["schemas"]["SavingsRatePoint"][]>(raw.POST("/api/rpc/get_savings_rate_history", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listReportWidgets: () => wrap<components["schemas"]["ReportWidget"][]>(raw.POST("/api/rpc/list_report_widgets", { body: {} } as unknown as { body: Record<string, never> })),
  createReportWidget: (title: string, chartType: "table" | "bar" | "barStacked" | "line" | "area" | "donut", splitBy: "category" | "group" | "payee" | "account" | "month" | "spendingType", period: "Last1Month" | "Last3Months" | "Last6Months" | "YTD" | "All", filtersJson?: string | null, position?: number | null) => wrap<components["schemas"]["ReportWidget"]>(raw.POST("/api/rpc/create_report_widget", { body: { title, chartType, splitBy, period, filtersJson, position } })),
  updateReportWidget: (id: string, title?: string | null, chartType?: "table" | "bar" | "barStacked" | "line" | "area" | "donut" | null, splitBy?: "category" | "group" | "payee" | "account" | "month" | "spendingType" | null, period?: "Last1Month" | "Last3Months" | "Last6Months" | "YTD" | "All" | null, filtersJson?: string | null) => wrap<components["schemas"]["ReportWidget"] | null>(raw.POST("/api/rpc/update_report_widget", { body: { id, title, chartType, splitBy, period, filtersJson } })),
  deleteReportWidget: (id: string) => wrap<boolean>(raw.POST("/api/rpc/delete_report_widget", { body: { id } })),
  reorderReportWidgets: (orderedIds: string[]) => wrap<components["schemas"]["ReportWidget"][]>(raw.POST("/api/rpc/reorder_report_widgets", { body: { orderedIds } })),
  ...
  listMonthCloses: () => wrap<components["schemas"]["MonthCloseListItem"][]>(raw.POST("/api/rpc/list_month_closes", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  explainGoals: () => wrap<components["schemas"]["MetricExplanation"][]>(raw.POST("/api/rpc/explain_goals", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getNotificationPrefs: () => wrap<components["schemas"]["NotificationPrefsDto"]>(raw.POST("/api/rpc/get_notification_prefs", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  markAllNotificationsRead: () => wrap<number>(raw.POST("/api/rpc/mark_all_notifications_read", { body: {} } as unknown as { body: Record<string, never> })),
  notificationUnreadCount: () => wrap<number>(raw.POST("/api/rpc/notification_unread_count", { body: {} } as unknown as { body: Record<string, never> })),
  householdNetWorthBreakdown: () => wrap<components["schemas"]["MemberNetWorth"][]>(raw.POST("/api/rpc/household_net_worth_breakdown", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listRestorationEnvelopes: () => wrap<components["schemas"]["RestorationEnvelope"][]>(raw.POST("/api/rpc/list_restoration_envelopes", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getFinancialPhilosophy: () => wrap<components["schemas"]["FinancialPhilosophyDto"]>(raw.POST("/api/rpc/get_financial_philosophy", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listSavedScenarios: () => wrap<components["schemas"]["SavedScenarioDetail"][]>(raw.POST("/api/rpc/list_saved_scenarios", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getTransactionCount: () => wrap<number>(raw.POST("/api/rpc/get_transaction_count", { body: {} } as unknown as { body: Record<string, never> })),
  listManualAssets: () => wrap<components["schemas"]["ManualAsset"][]>(raw.POST("/api/rpc/list_manual_assets", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  recordNetWorthSnapshot: () => wrap<null>(raw.POST("/api/rpc/record_net_worth_snapshot", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getUncelebratedMilestones: () => wrap<number[]>(raw.POST("/api/rpc/get_uncelebrated_milestones", { body: {} } as unknown as { body: Record<string, never> })),
  listHouseholdMembers: () => wrap<components["schemas"]["HouseholdMember"][]>(raw.POST("/api/rpc/list_household_members", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listAccountOwners: () => wrap<components["schemas"]["AccountOwner"][]>(raw.POST("/api/rpc/list_account_owners", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listAssetOwners: () => wrap<components["schemas"]["AssetOwner"][]>(raw.POST("/api/rpc/list_asset_owners", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getDataHealth: () => wrap<components["schemas"]["DataHealth"]>(raw.POST("/api/rpc/get_data_health", { body: {} } as unknown as { body: Record<string, never> })),
  createManualBackup: () => wrap<components["schemas"]["BackupInfo"]>(raw.POST("/api/rpc/create_manual_backup", { body: {} } as unknown as { body: Record<string, never> })),
  stageRestoreBackup: (path: string) => wrap<null>(raw.POST("/api/rpc/stage_restore_backup", { body: { path } })),
  cancelStagedRestore: () => wrap<null>(raw.POST("/api/rpc/cancel_staged_restore", { body: {} } as unknown as { body: Record<string, never> })),
  listAgentMemory: () => wrap<components["schemas"]["AgentMemory"][]>(raw.POST("/api/rpc/list_agent_memory", { body: {} } as unknown as { body: Record<string, never> })),
  forgetAgentMemory: (id: string) => wrap<null>(raw.POST("/api/rpc/forget_agent_memory", { body: { id } })),
  getFinancialHealthScore: () => wrap<components["schemas"]["HealthScore"]>(raw.POST("/api/rpc/get_financial_health_score", { body: {} } as unknown as { body: Record<string, never> })),
  listRuleProposals: () => wrap<components["schemas"]["RuleProposal"][]>(raw.POST("/api/rpc/list_rule_proposals", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listCategoryProposals: () => wrap<components["schemas"]["CategoryProposal"][]>(raw.POST("/api/rpc/list_category_proposals", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listAgentSessions: () => wrap<components["schemas"]["AgentSession"][]>(raw.POST("/api/rpc/list_agent_sessions", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listUnresolvedCounterparties: () => wrap<components["schemas"]["UnresolvedCounterpartyDto"][]>(raw.POST("/api/rpc/list_unresolved_counterparties", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getCurrency: () => wrap<string>(raw.POST("/api/rpc/get_currency", { body: {} } as unknown as { body: Record<string, never> })),
  setCurrency: (currency: string) => wrap<null>(raw.POST("/api/rpc/set_currency", { body: { currency } })),
  deleteAllData: () => wrap<null>(raw.POST("/api/rpc/delete_all_data", { body: {} } as unknown as { body: Record<string, never> })),
  exportAllDataJson: () => wrap<string>(raw.POST("/api/rpc/export_all_data_json", { body: {} } as unknown as { body: Record<string, never> })),
  exportAllDataCsv: () => wrap<string>(raw.POST("/api/rpc/export_all_data_csv", { body: {} } as unknown as { body: Record<string, never> })),
  getNotificationsEnabled: () => wrap<boolean>(raw.POST("/api/rpc/get_notifications_enabled", { body: {} } as unknown as { body: Record<string, never> })),
  setNotificationsEnabled: (enabled: boolean) => wrap<null>(raw.POST("/api/rpc/set_notifications_enabled", { body: { enabled } })),
  getAutoCategorizeEnabled: () => wrap<boolean>(raw.POST("/api/rpc/get_auto_categorize_enabled", { body: {} } as unknown as { body: Record<string, never> })),
  setAutoCategorizeEnabled: (enabled: boolean) => wrap<null>(raw.POST("/api/rpc/set_auto_categorize_enabled", { body: { enabled } })),
  getPlanNextMonthData: () => wrap<components["schemas"]["PlanData"]>(raw.POST("/api/rpc/get_plan_next_month_data", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getJourneyStatus: () => wrap<components["schemas"]["JourneyStatus"]>(raw.POST("/api/rpc/get_journey_status", { body: {} } as unknown as { body: Record<string, never> })),
  getActionItems: () => wrap<components["schemas"]["ActionItem"][]>(raw.POST("/api/rpc/get_action_items", { body: {} } as unknown as { body: Record<string, never> })),
  getInboxBadgeCount: () => wrap<components["schemas"]["InboxBadgeCount"]>(raw.POST("/api/rpc/get_inbox_badge_count", { body: {} } as unknown as { body: Record<string, never> })),
  getPushStatus: () => wrap<components["schemas"]["PushStatus"]>(raw.POST("/api/rpc/get_push_status", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listPushDevices: () => wrap<components["schemas"]["PushDevice"][]>(raw.POST("/api/rpc/list_push_devices", { body: {} } as unknown as { body: Record<string, never> })),
  sendTestPush: () => wrap<components["schemas"]["PushDeliveryReport"]>(raw.POST("/api/rpc/send_test_push", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  getSimplefinStatus: () => wrap<components["schemas"]["SimpleFinStatus"]>(raw.POST("/api/rpc/get_simplefin_status", { body: {} } as unknown as { body: Record<string, never> })),
  listSimplefinConnections: () => wrap<components["schemas"]["SimpleFinConnectionInfo"][]>(raw.POST("/api/rpc/list_simplefin_connections", { body: {} } as unknown as { body: Record<string, never> })),
  listSimplefinAccounts: () => wrap<components["schemas"]["SimpleFinAccountInfo"][]>(raw.POST("/api/rpc/list_simplefin_accounts", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  disconnectSimplefin: () => wrap<null>(raw.POST("/api/rpc/disconnect_simplefin", { body: {} } as unknown as { body: Record<string, never> })),
  purgeSimplefinData: () => wrap<components["schemas"]["SimpleFinPurgeSummary"]>(raw.POST("/api/rpc/purge_simplefin_data", { body: {} } as unknown as { body: Record<string, never> })),
  deleteSimplefinConnection: (connectionId: string) => wrap<null>(raw.POST("/api/rpc/delete_simplefin_connection", { body: { connectionId } })),
  syncAllSimplefinAccounts: () => wrap<components["schemas"]["AccountSyncResult"][]>(raw.POST("/api/rpc/sync_all_simplefin_accounts", { body: {} } as unknown as { body: Record<string, never> })),
  getSimplefinSyncSettings: () => wrap<components["schemas"]["SimpleFinSyncSettings"]>(raw.POST("/api/rpc/get_simplefin_sync_settings", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listSimplefinAlerts: () => wrap<components["schemas"]["SimpleFinAlert"][]>(raw.POST("/api/rpc/list_simplefin_alerts", { body: {} } as unknown as { body: Record<string, never> })),
  acknowledgeSimplefinAlert: (alertId: string) => wrap<null>(raw.POST("/api/rpc/acknowledge_simplefin_alert", { body: { alertId } })),
  listSimplefinTransferSuggestions: () => wrap<components["schemas"]["TransferSuggestionInfo"][]>(raw.POST("/api/rpc/list_simplefin_transfer_suggestions", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listImportReviewCandidates: () => wrap<components["schemas"]["ImportCandidateWithMatches"][]>(raw.POST("/api/rpc/list_import_review_candidates", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  listConversations: () => wrap<components["schemas"]["ConversationSummary"][]>(raw.POST("/api/rpc/list_conversations", { body: {} } as unknown as { body: Record<string, never> })),
  ...
  createConversation: () => wrap<string>(raw.POST("/api/rpc/create_conversation", { body: {} } as unknown as { body: Record<string, never> })),
...
export type CreateReportWidgetRequest = components["schemas"]["CreateReportWidgetRequest"];
export type UpdateReportWidgetRequest = components["schemas"]["UpdateReportWidgetRequest"];
export type DeleteReportWidgetRequest = components["schemas"]["DeleteReportWidgetRequest"];
export type ReorderReportWidgetsRequest = components["schemas"]["ReorderReportWidgetsRequest"];
