...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct GetRestorationStatusRequest {
    pub id: String,
}

#[utoipa::path(post, path = "/api/rpc/get_restoration_status",
    request_body(content = GetRestorationStatusRequest), responses((status = 200, body = Option<RestorationStatus>)))]
...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct CreateRestorationEnvelopeRequest {
    pub input: RestorationEnvelopeInput,
}

#[utoipa::path(post, path = "/api/rpc/create_restoration_envelope",
    request_body(content = CreateRestorationEnvelopeRequest), responses((status = 200, body = RestorationEnvelope)))]
...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct CloseRestorationEnvelopeRequest {
    pub id: String,
}

#[utoipa::path(post, path = "/api/rpc/close_restoration_envelope",
    request_body(content = CloseRestorationEnvelopeRequest), responses((status = 200, description = "Success")))]
...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct DeleteRestorationEnvelopeRequest {
    pub id: String,
}

#[utoipa::path(post, path = "/api/rpc/delete_restoration_envelope",
    request_body(content = DeleteRestorationEnvelopeRequest), responses((status = 200, description = "Success")))]
...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct AddRestorationLegRequest {
...
#[utoipa::path(post, path = "/api/rpc/add_restoration_leg", request_body(content = AddRestorationLegRequest), responses((status = 200, body = RestorationLeg)))]
...
#[serde(rename_all = "camelCase")]
#[schema(rename_all = "camelCase")]
pub struct RemoveRestorationLegRequest {
    pub leg_id: String,
}

#[utoipa::path(post, path = "/api/rpc/remove_restoration_leg",
    request_body(content = RemoveRestorationLegRequest), responses((status = 200, description = "Success")))]
